    ...
    template:`
     <div class="product">
            <div class="product-image">
                <!--want data to be content of src
                and data change -> src change -> v-bind-->
                <img v-bind:src="image" alt="Sock's image">
            </div>
            <div class="product-info">
                <!--{{ }} is expression-->
                <!--variable, operation, methods, condition-->
                <h1>{{ title }}</h1>
...
//Create instance Vue with element id 'app'
//Give that somw data
var app = new Vue({
    el:'#app',
    data:{
